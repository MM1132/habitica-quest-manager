...
const QUEST_SERIES = {
  ...
  goldenknight3: {
    ...
    prereqQuests: ['goldenknight1', 'goldenknight2'],
    value: 4,
    lvl: 40,
    category: 'unlockable',
    boss: {
  ...
  moonstone3: {
    ...
    previous: 'moonstone2',
    prereqQuests: ['moonstone1', 'moonstone2'],
    value: 4,
    lvl: 60,
    category: 'unlockable',
    boss: {
