...
const QUEST_MASTERCLASSER = {
  ...
  dilatoryDistress2: {
    ...
    prereqQuests: ['dilatoryDistress1'],
    value: 4,
    goldValue: 300,
    category: 'gold',
    boss: {
  ...
  dilatoryDistress3: {
    ...
    prereqQuests: ['dilatoryDistress1', 'dilatoryDistress2'],
    value: 4,
    goldValue: 400,
    category: 'gold',
    boss: {
  ...
  mayhemMistiflying2: {
    ...
    prereqQuests: ['mayhemMistiflying1'],
    value: 4,
    goldValue: 300,
    category: 'gold',
    collect: {
  ...
  stoikalmCalamity2: {
    ...
    prereqQuests: ['stoikalmCalamity1'],
    value: 4,
    goldValue: 300,
    category: 'gold',
    collect: {
  ...
  stoikalmCalamity3: {
    ...
    prereqQuests: ['stoikalmCalamity1', 'stoikalmCalamity2'],
    value: 4,
    goldValue: 400,
    category: 'gold',
    boss: {
  ...
  taskwoodsTerror3: {
    ...
    prereqQuests: ['taskwoodsTerror1', 'taskwoodsTerror2'],
    value: 4,
    goldValue: 400,
    category: 'gold',
    boss: {
  ...
  lostMasterclasser2: {
    ...
    prereqQuests: ['lostMasterclasser1'],
    value: 4,
    goldValue: 500,
    category: 'gold',
    boss: {
  ...
  lostMasterclasser3: {
    ...
    prereqQuests: ['lostMasterclasser1', 'lostMasterclasser2'],
    value: 4,
    goldValue: 600,
    category: 'gold',
    boss: {
...
module.exports = { QUEST_MASTERCLASSER };
